...
def compute_epsilon(sigma, sampling_prob, global_iterations, delta, verbose=False):
    total_rdp = np.atleast_1d(
        compute_rdp(sampling_prob, sigma, global_iterations, DEFAULT_ALPHAS)
    )
